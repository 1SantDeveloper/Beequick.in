...
<div class="container" style=" margin-top:80px;">
  <h3 style="margin-bottom:8px; ">Order Bill <small> Customer Copy</small></h3>
  <div class="text-center"><button class="btn btn-default" onclick="window.print()">Print Invoice</button>
  <a href="user_dashboard.php"><button class="btn btn-link">Go to Dashboard</button></a>
  </div>
  <br>
</div>
...
<p style="float:right"><b>Customer Copy</b></p>
<div class="row">
...
<td>
    ...
    <td>
        <p><b>Order ID:</b> <?php echo $query_result->result[0]["id"]?></p>
...
<table class="table table-responsive" style="font-size:18px;">
    ...
    <tbody>
        <tr>
            ...
            <td>
            <img alt="<?php echo $query_result->result[0]["id"] ?>" src="admin/barcode/barcode.php?codetype=Code39&size=40&text=<?php echo $query_result->result[0]["id"] ?>&print=false&orientation=vertical" style="float:right; width: 90px;height:200px;" />
            </td>
        </tr>
    </tbody>
</table>
